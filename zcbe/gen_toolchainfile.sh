...
set(CMAKE_C_FLAGS "-isystem ${ZCPREF}/include -DDBL_EPSILON=__DBL_EPSILON__ -DFLT_EPSILON=__FLT_EPSILON__ -DLDBL_EPSILON=__LDBL_EPSILON__ \${CMAKE_C_FLAGS}")
#set(CMAKE_CXX_FLAGS "-static-libgcc -static-libstdc++ \${CMAKE_CXX_FLAGS}")
set(CMAKE_CXX_FLAGS "-isystem ${ZCPREF}/include -DDBL_EPSILON=__DBL_EPSILON__ -DFLT_EPSILON=__FLT_EPSILON__ -DLDBL_EPSILON=__LDBL_EPSILON__ \${CMAKE_CXX_FLAGS}")
